...
# os.chdir(os.path.join(os.getcwd(), 'modified_lightreid'))
# os.chdir(os.path.join(os.getcwd(), 'utils', 'modified_lightreid'))
from modified_lightreid import lightreid
import yaml
import time
import numpy as np
...
def build_inference(config_path, model_path):
    """
    ...
    # inference only
    inference = lightreid.build_inference(config, model_path=model_path, use_gpu=use_gpu)
    return inference
