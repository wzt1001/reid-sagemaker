...
def build_inference(cfg, model_path, use_gpu=False, resnet50_model_dir=None, resnet50_model_file_name=None):
    ...
    model = build_model(resnet50_model_dir=resnet50_model_dir, resnet50_model_file_name=resnet50_model_file_name, **cfg.model)
