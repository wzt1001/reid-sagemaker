...
def build_model(backbone, resnet50_model_dir, resnet50_model_file_name, pooling, head, **kwargs):
    """
    Args:
    Example:
    """
    ...
    # init
    backbone = build_cnnbackbone(name=backbone.pop('name'), resnet50_model_dir=resnet50_model_dir, resnet50_model_file_name=resnet50_model_file_name, **backbone)
