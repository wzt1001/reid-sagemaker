...
def resnet50_ibn_a(pretrained=False, model_dir=None, file_name=None, **kwargs):
    ...
    model = ResNet_IBN(block=Bottleneck_IBN,
                       ...
                       ibn_cfg=('a', 'a', 'a', None))
    if pretrained:
        # 改了这里：add map location argument here
        model.load_state_dict(torch.hub.load_state_dict_from_url(model_dir=model_dir, file_name=file_name, url=None, map_location=kwargs.pop('map_location')))
