...
class ResNet(nn.Module):
    ...
    def __init__(self, name, pretrained=True, last_stride_one=True, map_location=None, resnet50_model_dir=None,
                 resnet50_model_file_name=None):
        ...
        self.resnet50_model_dir = resnet50_model_dir
        self.resnet50_model_file_name = resnet50_model_file_name
        ...
        if self.name == 'resnet18':
            ...
            resnet = resnet50_ibn_a(pretrained=pretrained, model_dir=resnet50_model_dir, file_name=resnet50_model_file_name, last_stride_one=last_stride_one, map_location=map_location)
            self.dim = 2048
...
def resnet50ibna(pretrained=True, last_stride_one=True, resnet50_model_dir=None, resnet50_model_file_name=None, **kwargs):
  # 改了这里：
    # return ResNet(name='resnet50ibn', pretrained=pretrained, last_stride_one=last_stride_one)
    return ResNet(name='resnet50ibn', resnet50_model_dir=resnet50_model_dir, resnet50_model_file_name=resnet50_model_file_name, pretrained=pretrained, last_stride_one=last_stride_one, **kwargs)
