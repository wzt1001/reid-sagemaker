...
def build_cnnbackbone(name, resnet50_model_dir=None, resnet50_model_file_name=None, pretrained=True, **kwargs):
    return __cnnbackbone_factory[name](pretrained=pretrained, resnet50_model_dir=resnet50_model_dir, resnet50_model_file_name=resnet50_model_file_name, **kwargs)